...
" Cobol
au BufNewFile,BufRead *.cob,*.lib	setf cobol
"   cobol or zope form controller python script? (heuristic)
au BufNewFile,BufRead *.cyp
	\ if getline(1) =~ '^##' |
	\   setf python |
	\ else |
	\   setf cobol |
...
" Cob400
au BufNewFile,BufRead *.cbl,*.cpy	setf Cob400
"   Cob400 or zope form controller python script? (heuristic)
