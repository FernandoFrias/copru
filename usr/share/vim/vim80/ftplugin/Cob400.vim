...
" $Id: Cob400.vim,v 1.1 2007/05/05 17:24:38 vimboss Exp $
...
if !exists("g:no_plugin_maps") && !exists("g:no_Cob400_maps")
    ...
    nnoremap <silent> <buffer> >> :call Cob400IndentBlock(1)<CR>
    nnoremap <silent> <buffer> << :call Cob400IndentBlock(-1)<CR>
    vnoremap <silent> <buffer> > :call Cob400IndentBlock(v:count1)<CR>
    vnoremap <silent> <buffer> < :call Cob400IndentBlock(-v:count1)<CR>
...
if exists("g:did_Cob400_ftplugin_functions")
    finish
endif
let g:did_Cob400_ftplugin_functions = 1
...
function! Cob400IndentBlock(shift)
...
function! s:IncreaseIndent()
    ...
    let b:Cob400_shiftwidth = &shiftwidth
    let &shiftwidth = 1
...
function! s:RestoreShiftwidth()
    if exists("b:Cob400_shiftwidth")
        let &shiftwidth=b:Cob400_shiftwidth
        unlet b:Cob400_shiftwidth
    endif
    return ""
endfunction
