...
" $Id: Cob400.vim,v 1.1 2007/05/05 18:08:19 vimboss Exp $
...
function! GetCob400Indent(lnum) abort
    let minshft = 6
    let ashft = minshft + 1
    let bshft = ashft + 4
