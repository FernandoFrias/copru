...
function! s:InitTypes() abort
    ...
    " COBOL400 {{{3
    let type_Cob400 = s:TypeInfo.New()
    let type_Cob400.ctagstype = 'Cob400'
    let type_Cob400.kinds     = [
        \ {'short' : 'd', 'long' : 'Division',          'fold' : 0, 'stl' : 1},
        \ {'short' : 'e', 'long' : 'Seccion',           'fold' : 1, 'stl' : 1},
        \ {'short' : 'g', 'long' : 'Variable-grupo',    'fold' : 1, 'stl' : 1},
        \ {'short' : 'v', 'long' : 'Variable-dato',     'fold' : 1, 'stl' : 1},
        \ {'short' : 'r', 'long' : 'Cursor',            'fold' : 1, 'stl' : 1},
        \ {'short' : 's', 'long' : 'Switch',            'fold' : 1, 'stl' : 1},
        \ {'short' : 'c', 'long' : 'Copy',              'fold' : 1, 'stl' : 1},
        \ {'short' : 'i', 'long' : 'Include',           'fold' : 1, 'stl' : 1},
        \ {'short' : 'p', 'long' : 'Parrafo',           'fold' : 0, 'stl' : 1},
        \ {'short' : 'l', 'long' : 'Call',              'fold' : 1, 'stl' : 1}
    \ ]
    let s:known_types.Cob400 = type_Cob400
    " DOS Batch {{{3
    ...
    let type_tex.kinds     = [
        \ {'short' : 'Q', 'long' : 'Paquetes',    'fold' : 1, 'stl' : 1},
        \ {'short' : 'U', 'long' : 'Capitulos',   'fold' : 1, 'stl' : 1},
        \ {'short' : '1', 'long' : 'Seccion(1)',  'fold' : 0, 'stl' : 1},
        \ {'short' : '2', 'long' : 'Seccion(2)',  'fold' : 1, 'stl' : 1},
        \ {'short' : '3', 'long' : 'Seccion(3)',  'fold' : 1, 'stl' : 1},
        \ {'short' : 'R', 'long' : 'Parrafos',    'fold' : 1, 'stl' : 1},
        \ {'short' : 'A', 'long' : 'Subparrafos', 'fold' : 1, 'stl' : 1},
        \ {'short' : 'I', 'long' : 'Imágenes',    'fold' : 1, 'stl' : 1},
        \ {'short' : 'E', 'long' : 'Etiquetas',   'fold' : 1, 'stl' : 1}
    \ ]
    let type_tex.sro        = '""'
